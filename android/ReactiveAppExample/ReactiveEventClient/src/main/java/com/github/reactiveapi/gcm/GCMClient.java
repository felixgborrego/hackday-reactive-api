package com.github.reactiveapi.gcm;
...
public class GCMClient {
    ...
    private static String TAG = "GCMClient";
    ...
    private ReactiveApiClient reactiveClient;
    ...
    public void start(String projectId, final Activity context,ReactiveApiClient reactiveClient) {
        senderId = projectId;
    ...
    private void sendRegistrationIdToBackend() {
        ...
        Log.i(TAG, "Sending Registratin id to Backend + "+ regid);
    }
